    ...
    return (
        <div className="ant-space-compact">
            <Tooltip placement="top" title={<span>Download {key} + S</span>}>
                <Button type="primary" className="rounded-se-none rounded-ee-none me-[-1px] hover:z-[1] border-r-white/30 bg-black" disabled={disabled} loading={loading} icon={<Icon name="Download" />} onClick={toDownload}>Download {!disabled && <span className='text-[red] text-xs'>(0.1credits)</span>}</Button>
            </Tooltip>
