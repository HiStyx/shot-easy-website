		...
		<>
			<div className='flex justify-center items-center gap-2 mb-6'>
				<div className='relative'>
					...
					/>
					<span className='absolute text-xs opacity-60 top-8 left-[50%] translate-x-[-50%]'>
						Or paste it
					</span>
					<svg
						className='absolute -right-12 top-1 opacity-80'
					...
					>
						<g>
							<path
								d='m74.3 66.8-5.8 5.8c-.6-20.7-8.9-27.8-13.6-30.1-.1-.4-.1-.8-.2-1.2-1-4.1-5.9-17.3-29.5-17.3h-.1v2h.1C47 26 51.7 37.9 52.6 41.7c-4.1-1.2-8-.2-9.7 2.4-1.5 2.3-1 5.2 1.4 8.1 3 3.6 5.7 2.8 6.7 2.3 2.6-1.3 4.2-5.2 4-9.5 5.7 3.4 10.9 12 11.4 27.6l-5.7-5.7-1.4 1.4 8.2 8.2 8.2-8.2zM50.1 52.7c-1.6.8-3.2-.5-4.3-1.8-1.8-2.1-2.2-4.2-1.2-5.7.9-1.3 2.6-2 4.6-2 .9 0 1.9.1 2.9.4l.9.3c.4 4.3-1 7.8-2.9 8.8z'
								fill='#000000'
								opacity='1'
							></path>
						</g>
					...
					<FilerobotImageEditor
						...
						onBeforeSave={() => {
							setTimeout(() => {
								...
								buttons[buttons.length - 1].innerHTML = 'save <span style="color: #fc4041; font-size: 12px;">(0.1credits)</span>'
							})
						}}
